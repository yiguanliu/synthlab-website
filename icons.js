// Minimal inline icon set in the lucide / shadcn stroke style (24px grid, 1.5px stroke).
// Kept as plain template strings — no runtime deps, no extra requests.
const ICONS = {
  ...
  factory: `<path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-7 4V8l-7 4V4l-6 4z"/><path d="M2 20v-9"/>`,
  sparkles: `<path d="M12 3v4"/><path d="M12 17v4"/><path d="M3 12h4"/><path d="M17 12h4"/><path d="m6 6 2.5 2.5"/><path d="m15.5 15.5 2.5 2.5"/><path d="m6 18 2.5-2.5"/><path d="m15.5 8.5 2.5-2.5"/><circle cx="12" cy="12" r="2.5"/>`,
  ...
  drone: `<circle cx="12" cy="12" r="2.5"/><path d="m6 6-2-2"/><path d="m18 6 2-2"/><path d="m6 18-2 2"/><path d="m18 18 2 2"/><circle cx="4.5" cy="4.5" r="2"/><circle cx="19.5" cy="4.5" r="2"/><circle cx="4.5" cy="19.5" r="2"/><circle cx="19.5" cy="19.5" r="2"/>`,
